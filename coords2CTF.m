function [Hx, Hy, Hz,MEG_nasion_pos,MEG_left_preauricular_pos,MEG_right_preauricular_pos ]=coords2CTF(Hx, Hy, Hz, nasion_pos, left_preauricular_pos, right_preauricular_pos );
...
% adapted from Bitebar2MEG - 2015 Gavin Perry 
