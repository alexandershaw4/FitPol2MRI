function [endpoints,R]=inv_trans_3d(th,T,startpoints);
%%function [endpoints,T]=inv_trans_3d(th,T,startpoints);
...
transpoints=R1*startpoints4';
endpoints4=R*transpoints;
